	...
	<div class="body-inner">
		...
		<div id="main-slide" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<div class="item active" style="background-image:url(images/slider-main/header1.jpg)">
					<div class="slider-content">
						<div class="col-md-12 text-center">
							
							<br><br><h3 class="slide-sub-title animated5">Sindicato de Ciudadadanos de "La Tierra"</h3>
				...
				<div class="item" style="background-image:url(images/slider-main/header2.jpg)">
					<div class="slider-content">
						<div class="col-md-12 text-center">
							
							<h3 class="slide-sub-title animated5">Sindicato de Ciudadadanos de "La Tierra"</h3>
				...
				<div class="item" style="background-image:url(images/slider-main/header3.jpg)">
					<div class="slider-content">
						<div class="col-md-12 text-center">
					...
					<div class="row">
						<div class="col-md-10">
							<div class="call-to-action-text">
								<h3 class="action-title">Obten tu documento de identidad</h3>
							</div>
						</div><!-- Col end -->
						<div class="col-md-2">
