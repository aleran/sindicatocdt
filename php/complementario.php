<?php 
	...
	$sql="UPDATE datos_personales set fecha_nacimiento='".$_POST["fecha_n"]."', estatura='".$_POST["estatura"]."', color_piel='".$_POST["color_piel"]."', particular='".$_POST["particular"]."', foto='foto_" . "5" . ".png'";
	...
	$sql="UPDATE datos_complem set tipo_sangre='".$_POST["sangre"]."', profesion='".$_POST["profesion"]."', universidad='".$_POST["universidad"]."', telefono='".$_POST["telefono"]."', pais_recidencia='".$_POST["pais_r"]."', ciudad='".$_POST["ciudad_r"]."', direccion='".$_POST["direccion"]."', tipo_documento='".$_POST["tipo_documento"]."', documento_o='".$_POST["documento_o"]."', servicio_militar='".$_POST["servicio_m"]."', seguro_social='".$_POST["seguro_social"]."', pais_ss='".$_POST["pais_ss"]."', fecha_ss='".$_POST["fecha_ss"]."', observaciones='".$_POST["observaciones"]."' ";
	...
	$sql="UPDATE documentos set fecha='".date("Y-m-d")."', pais='".$pais["id"]."' ";
